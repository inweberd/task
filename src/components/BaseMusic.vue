<template>
	<div class="music-wrapper">
		<div class="mute-icon" :class="showMutedNotice && 'notice'" v-click="() => bus.emit(EVENT_KEY.REMOVE_MUTED)"
			v-if="isMuted">
			<div class="wrap">
		...
		<img class="music" :src="item.music?.cover_thumb.url_list[0]" :style="style" v-click="() =>
