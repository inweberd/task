<template>
	<div class="video-wrapper" ref="videoWrapper" :class="positionName">
		...
		<video :src="item.video.play_addr.url_list[0]" :poster="poster" ref="videoEl" :muted="state.isMuted" preload="true"
			loop x5-video-player-type="h5-page" :x5-video-player-fullscreen="false" :webkit-playsinline="true"
			:x5-playsinline="true" :playsinline="true" :fullscreen="false" :autoplay="isPlay">
		...
		<div class="float">
			...
			<template v-else>
				...
				<div class="progress" :class="progressClass" ref="progressEl" @click="null" @touchstart="touchstart"
