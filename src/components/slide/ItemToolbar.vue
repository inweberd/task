...
<template>
	<div class="toolbar mb1r">
		<div class="avatar-ctn mb2r">
			...
			<div class="fnn">
				<img v-click="() => bus.emit(EVENT_KEY.GO_USERINFO, {
					data: 1
				})" src="../../assets/赚现金.png" style=" width: 40rem;
	height: 60rem;padding-bottom: 20rem;" />
		...
		<div class="message mb2r" v-click="() => _updateItem(props, 'isCollect', !item.isCollect)">
			<Icon v-if="item.isCollect" icon="ic:round-star" class="icon" style="color: rgb(252, 179, 3)" />
