<template>
    <div class="wrap">
        ...
        <template v-if="qrCodeValue">
            ...
            <div class="btns">
                <van-image :src="weixin" fit="fill" height="60" width="60"></van-image>
                <van-image :src="pengyouquan" fit="fill" height="50" width="50"></van-image>
            </div>
        </template>
    </div>
</template>
...
export default {
    ...
    mounted() {
        this.qrCodeValue = 'https://wvvw.weimeihuang.com/#/signUp?invite='
