...
import ShortSlideVerticalInfinite from '@/components/slide/ShortSlideVerticalInfinite.vue'
...
async function getData(refresh = false) {
  ...
  if (res.success) {
    ...
    // state.list = state.list.concat(props.list)
