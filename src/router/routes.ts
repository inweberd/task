...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/longvideo',
    component: () => import('@/pages/home/slide/LongVideo.vue')
  },
  ...
  { path: '/xukezheng2', component: () => import('@/pages/me/xukezheng2.vue') },
  { path: '/dianxin', component: () => import('@/pages/me/dianxin.vue') },
  ...
  },
  {
    ...
    component: () => import('@/pages/other/ShortPlayDetail.vue')
  },
